...
The TrueNAS broker and dedicated node containers both consume that value
through their respective deployment secret injection. The node reaches the
broker's machine-authenticated HTTPS routes through
