...
| Published plans | Partial | High | Postgres-backed integration tests cover create/update/complete/history/app-state projection plus the full branch cycle (span anchors, depth-2 nesting, close refusal, return-to-parent); component tests cover browser creation, phase updates, branching, and returning. | Add a real-stack browser scenario for sidebar creation, PTY attachment, phase completion, branch/return with the PTY following the work, Overview projection, and closed history. |
